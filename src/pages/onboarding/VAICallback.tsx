    ...
    const checkVerification = async () => {
      ...
      if (!user && sessionId) {
        ...
        try {
          ...
          const restoreUserSession = async () => {
            ...
            try {
              ...
              if (parsed.email && parsed.password) {
                ...
                if (signInError) {
                  console.error('Automatic login failed on callback:', signInError);
                  return null;
                }
              ...
              console.error('Failed to parse stored signup data during callback', error);
            }
            return null;
          };
          ...
          if (!authUser) {
            authUser = await restoreUserSession();
          }

          if (!authUser) {
            setStatus('error');
            setMessage('We could not verify your account session. Please log in again.');
            return;
          }
          activeUser = authUser;
