...
export default function Pricing() {
  ...
  const handleContinueFree = async () => {
    ...
    if (userId) {
      ...
      // Check if provider profile already exists (username required in profile creation flow)
      ...
      if (profileError) {
        console.error("Failed to check provider profile:", profileError);
        toast({
          title: "Warning",
          description: "Could not verify profile status. Continuing setup...",
        });
    ...
    navigate(hasCompletedProfile ? "/feed" : "/profile-creation");
  };
