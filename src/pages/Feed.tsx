...
export default function Feed() {
  ...
  const greetingName = username || "Please Create a User Name";
  const publicName = username || "Private";
  const profilePhoto = profile?.avatar_url?.trim();
                ...
                <CardContent className="pt-3 space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-foreground mt-1">
                      <span className="font-semibold">{publicName}</span> Venice is nice this time of year 🌉✨
                    </p>
                ...
                <Card className="animate-fade-in border-border overflow-hidden">
                  ...
                  <CardContent className="pt-3 space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-foreground mt-1">
                        <span className="font-semibold">{greetingName}</span> Beach vibes 🌊 Perfect day in Miami!
                      </p>
